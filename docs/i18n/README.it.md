...
- 🛡️ **Irrobustito** — fail‑closed per default, anti‑SSRF (con ri‑validazione a ogni hop di redirect), scrub dei segreti per job, gating per ruolo su REST **e** MCP, rate‑limiting, container non‑root. Auditato.
